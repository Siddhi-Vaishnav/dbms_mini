...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit'])) {
    ...
    $sql = "UPDATE residents SET name=?, contact_details=?, unit_number=?, vehicle_info=? WHERE resident_id=?";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("sssss", $name, $contact_details, $unit_number, $vehicle_info, $resident_id);
